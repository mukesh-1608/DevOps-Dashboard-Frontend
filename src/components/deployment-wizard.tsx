    ...
    <>
      ...
      <div className="rounded-2xl border border-gray-200/50 bg-white/60 p-1 shadow-sm backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-800/40">
        <div className="p-6">
            ...
            {/* --- PREMIUM "GHOST GLASS" BUTTON --- */}
            {/* This button uses a dark, semi-transparent background (gray-900)
                with a subtle white border ring. It looks like a physical button
                on a piece of high-end equipment.
            */}
            <div className="mt-8">
                <button 
                type="submit" 
